...
**Follow Infinitive coding standards.** Before writing or editing Python, SQL, or Databricks-specific code (pipelines, ML scripts, app code, notebooks), consult `SKILLS/infinitive-coding-standards/SKILL.md`. Read `client_instructions.md` first — it overrides every other instruction file there on conflict — then the index file for the language you're writing (`python_instructions.md` / `sql_instructions.md` / `databricks_instructions.md`) and the specific topic file(s) it points to (style, testing, security, design, etc.).
